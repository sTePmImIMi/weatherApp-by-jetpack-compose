...
private fun getData(city: String, context: Context, days_list: MutableState<List<WeatherModel>>) {
    ...
    val request = StringRequest(
        ...
        url,
        { response ->
            days_list.value = getWeatherByDays(response)
        },
        {
